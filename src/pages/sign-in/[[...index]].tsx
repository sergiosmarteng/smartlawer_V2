      ...
      <div className="flex min-h-screen items-center justify-center bg-papel px-4">
        <div className="w-full max-w-md rounded-[5px] border border-linha bg-white p-8 shadow-[0_4px_10px_rgba(41,69,50,0.05)]">
          <div className="mb-8 text-center">
            ...
            <h1 className="mt-3 font-display text-3xl font-normal tracking-tight text-tinta">Acessar a plataforma</h1>
            <p className="mt-2 text-sm text-tinta-suave">Acesse seu escritório jurídico digital</p>
          </div>

          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              <label htmlFor="signin-email" className="mb-1 block text-sm text-tinta">E-mail</label>
              <input
                id="signin-email"
                type="email"
                value={email}
            ...
            <div>
              <label htmlFor="signin-password" className="mb-1 block text-sm text-tinta">Senha</label>
              <input
                id="signin-password"
                type="password"
                value={password}
          ...
          <p className="mt-6 text-center text-sm text-tinta-suave">
            Ainda não tem conta?{' '}
            <Link href={signUpHref} className="font-medium text-latiim-texto underline underline-offset-4 hover:text-tinta-profunda">
              Criar conta
            </Link>
          </p>
        </div>
