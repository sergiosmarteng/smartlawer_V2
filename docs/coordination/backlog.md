...
| BL-016 | P1 | Add Docling-based ingestion with Markdown persistence and fallback | backend/ai | BL-011, BL-012 | planned | Introduce a feature-flagged `Docling -> structured markdown/json -> LegalAnalyzer` pipeline while keeping the current extractor as fallback. |
