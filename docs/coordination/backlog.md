...
| BL-018 | P1 | Add production observability and audit trail | platform/backend | BL-011, BL-012 | completed | Landed 2026-09-08: audit trail + ops summary + workflow timing. See `reports/worker-c4-audit-rbac.md`. |
